...
const Alert = ({type, title, subtitle, className}: Props) => {
  return (
    <div className={cn("flex justify-start items-center gap-2 p-3 rounded-md border", type === "success" ? "border-green-700 bg-green-100" : "border-destructive bg-red-100", className)}>
